import { ButtonInteraction, ColorResolvable, EmbedBuilder, MessageFlags, TextChannel, User } from "discord.js"
...
export default {
  async buttonHandlerFunction(client: MyClient, interaction: ButtonInteraction) {
    ...
    const newButton = Buttons.close.components[0].setDisabled(false)
